...
{
    public class ReferencesRepository:GenericRepository<Entities.EntityModels.tblReferences>,IReferencesRepository
    {
        public ReferencesRepository(IDbConnection dbConnection, IDBTransactionFactory dbTransactionFactory) : base(dbConnection, dbTransactionFactory)
        {
