...
{
	public class SettingRepository : GenericRepository<Entities.EntityModels.tblSetting>, ISettingRepository
	{
		public SettingRepository(IDbConnection dbConnection, IDBTransactionFactory dbTransactionFactory) : base(dbConnection, dbTransactionFactory)
		{
