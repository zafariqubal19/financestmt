...
{
    public class ResourceSecurityRepository : GenericRepository<Entities.EntityModels.tblResourceSecurity>, IResourceSecurityRepository
    {
        public ResourceSecurityRepository(IDbConnection dbConnection, IDBTransactionFactory dbTransactionFactory) : base(dbConnection, dbTransactionFactory)
        {
        }
    }
}
